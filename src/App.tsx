...
import { faPen, faEraser, faBell } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { connect } from "react-redux";
import { InitialStateType } from "./TodoPropStorage";
...
function App<_InitialStateType>({ state }: any) {
  console.log(state);
